...
<head>
    ...
    <meta name="description" content="Review King admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, Review King admin template, dashboard template, flat admin template, responsive admin template, web app">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('dashboard') }}"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">Review King</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="{{ Request::path() == 'dashboard' ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{ url('dashboard') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span></a>
                ...
                @if (Auth::user()->role == 1)
                    <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="Company">Company</span></a>
                        <ul class="menu-content">
                            ...
                            <li class="{{ Request::path() == 'company/create' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ url('company/create') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">Add</span></a>
                            </li>
                        </ul>
                    </li>
                @endif
