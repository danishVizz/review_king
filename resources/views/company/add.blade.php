                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ isset($data->id)? 'Update':'Add' }} Company Detail</h4>
                        </div>
                        <div class="card-body">
                            ...
                            @if (isset($data->id))
                                <form class="form" action="{{ route('company.update', $data->id) }}" method="post">
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('phone_no', isset($data->phone_no)? $data->phone_no: '')}}" type="text" id="phone_no" class="form-control @error('phone_no') is-invalid @enderror" placeholder="Phone Number" name="phone_no">
                                            @error('phone_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
