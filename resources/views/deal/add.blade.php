...
@if (isset($data->id))
    @section('title', 'Update Gift Order')
@else
    @section('title', 'Add Gift Order')
@endif
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ isset($data->id)? 'Update':'Add' }} Gift Order Detail</h4>
                        </div>
                        <div class="card-body">
                            ...
                            @if (isset($data->id))
                                <form class="form" action="{{ route('deal.update', $data->id) }}" method="post">
                                @method('PUT')
                                
                            @else
                                <form class="form" action="{{ route('deal.store') }}" method="POST">
